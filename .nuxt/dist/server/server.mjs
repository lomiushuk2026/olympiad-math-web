import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, defineComponent, computed, unref, provide, ref, watch, h, isReadonly, isRef, isShallow, isReactive, toRaw, Suspense, Fragment, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/h3@1.15.10/node_modules/h3/dist/index.mjs";
import { defu } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL as parseURL$1, encodePath as encodePath$1, decodePath, withQuery, isScriptProtocol } from "/Users/lomiushuk/olympiad-math/web/node_modules/.pnpm/ufo@1.6.3/node_modules/ufo/dist/index.mjs";
...
const unhead_mCMmz_zStTft1vLqbANObIZSUdAiOKo0Nj99aY062RY = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "daily",
    path: "/daily",
    component: () => import("./_nuxt/daily-DA52BPr_.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DicIthji.js")
  },
  {
    name: "wrong",
    path: "/wrong",
    component: () => import("./_nuxt/wrong-Btr8MQaI.js")
  },
  {
    name: "practice-gradeId-topicId",
    path: "/practice/:gradeId()/:topicId()",
    component: () => import("./_nuxt/_topicId_-BdWCohFj.js")
  }
];
...
const revive_payload_server_m1kT7M_KnxtZtuLj0MCI4Y2Vr0jOD_QZt_t0asIH_sQ = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_mCMmz_zStTft1vLqbANObIZSUdAiOKo0Nj99aY062RY,
  plugin,
  revive_payload_server_m1kT7M_KnxtZtuLj0MCI4Y2Vr0jOD_QZt_t0asIH_sQ,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D3GVACra.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CxPb2EY8.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.2_@parcel+watcher@2.5.6_@types+node@22.19.15_@vitejs+devtools@0.1.11_@pnpm+lo_13ca0fe68f37494a7d4df93a6fa23748/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.2_@parcel+watcher@2.5.6_@types+node@22.19.15_@vitejs+devtools@0.1.11_@pnpm+lo_13ca0fe68f37494a7d4df93a6fa23748/node_modules/nuxt/dist/app/components/nuxt-root.vue");
